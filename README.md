...
[`ECG_PRECLINICAL_VALIDATION_CHECKPOINT.json`](ECG_PRECLINICAL_VALIDATION_CHECKPOINT.json) — frozen engineering basis and entry controls for clinical-accuracy evaluation.
