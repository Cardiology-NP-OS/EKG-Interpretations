...
const REQUIRED = [
  ...
  "tests/signal_quality.test.js",
  "tests/quality_report.test.js",
  "lib/wfdb_signal.js",
  "lib/signal_quality.js",
  "manifests/SOURCE_INSPECTION_SCHEMA.json",
  "manifests/SIGNAL_QUALITY_SCHEMA.json",
  "tools/inspect_signal.js",
  "tools/quality_report.js",
...
function gate() {
  ...
  const suites = [
    ...
    ["signal_quality.test.js", "SIGNAL_QUALITY_TESTS_FAILED"],
    ["quality_report.test.js", "QUALITY_REPORT_TESTS_FAILED"],
  ];
  ...
  return {
    ...
    signal_quality_tests_passed: 6,
    quality_report_tests_passed: 5,
    ci_tests_total: 30,
