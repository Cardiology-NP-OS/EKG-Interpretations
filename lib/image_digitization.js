...
function traceRowsForRoi(image, roi, inkCeiling, maxHeldColumns) {
...
function digitizeRoi(image, roi, calibration, inkCeiling, maxHeldColumns) {
  const traced = traceRowsForRoi(image, roi, inkCeiling, maxHeldColumns);
  ...
  return { samples, ys: traced.ys, observedYs: traced.observedYs, quality: traced.quality };
}
