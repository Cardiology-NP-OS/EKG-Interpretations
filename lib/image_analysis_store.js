...
function validateAnalysis(analysis, caseRecord, extraction) {
  ...
  requireCondition(
    analysis.temporalAlignmentPolicy === "STANDARD_3X4_PANEL_WINDOWS_ONLY_RHYTHM_STRIP_EXCLUDED_FROM_SIMULTANEOUS_GROUPS",
  ...
  const expectedGroups = buildSimultaneousPaperGroups(analysis.leadAnalyses);
  requireCondition(
