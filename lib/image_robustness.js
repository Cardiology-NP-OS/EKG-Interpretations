...
function deterministicNoiseField(width,height,{amplitude=8,period=17}={}){
  requireCondition(Number.isSafeInteger(width)&&width>0&&Number.isSafeInteger(height)&&height>0,"IMAGE_ROBUSTNESS_NOISE_DIMENSIONS");
  requireCondition(width<=4000&&height<=4000&&width*height<=4_000_000,"IMAGE_ROBUSTNESS_NOISE_PIXEL_BUDGET");
