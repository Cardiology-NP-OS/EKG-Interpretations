...
function runImageFileIntake(input) {
  ...
  const intakeInput = {
    ...
    verifyLeadLabelsFromRaster: input.verifyLeadLabelsFromRaster === true,
    leadLabelScale: input.leadLabelScale,
    leadLabelDarkThreshold: input.leadLabelDarkThreshold,
    leadLabelSearchRadius: input.leadLabelSearchRadius,
    leadLabelMinScore: input.leadLabelMinScore,
    leadLabelOffsetX: input.leadLabelOffsetX,
    leadLabelOffsetY: input.leadLabelOffsetY,
    perspectiveCorners: input.perspectiveCorners,
    perspectiveCornersVerified: input.perspectiveCornersVerified === true,
    allowPerspectiveDetection: input.allowPerspectiveDetection === true,
    perspectiveDetectionDarkThreshold: input.perspectiveDetectionDarkThreshold,
    perspectiveDetectionMaxSamples: input.perspectiveDetectionMaxSamples,
    perspectiveDetectionMinAreaFraction: input.perspectiveDetectionMinAreaFraction,
    perspectiveDetectionMinEdgeSupportFraction: input.perspectiveDetectionMinEdgeSupportFraction,
    perspectiveDetectionEdgeTolerancePx: input.perspectiveDetectionEdgeTolerancePx,
    perspectiveDetectionEdgeSamples: input.perspectiveDetectionEdgeSamples,
    perspectiveOutputWidth: input.perspectiveOutputWidth,
    perspectiveOutputHeight: input.perspectiveOutputHeight,
    allowOrientationSearch: input.allowOrientationSearch === true,
    allowDeskewSearch: input.allowDeskewSearch === true,
    maxDeskewDegrees: input.maxDeskewDegrees,
    deskewStepDegrees: input.deskewStepDegrees,
    deskewDarkThreshold: input.deskewDarkThreshold,
    deskewMaxSamples: input.deskewMaxSamples,
    minimumDeskewCorrectionDegrees: input.minimumDeskewCorrectionDegrees,
    deskewCropThreshold: input.deskewCropThreshold,
    ...
    strictTraceMaxThicknessPx: input.strictTraceMaxThicknessPx,
