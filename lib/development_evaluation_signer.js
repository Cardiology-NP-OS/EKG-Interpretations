...
function prepareSignerInputs(config, options = {}) {
  ...
  return { repositoryRoot, candidateRoot, syntheticTest, candidateManifest, candidateSignature, candidateTrustStore, execution, candidateRuntime, candidateIsolation, governance, identity, loadedRecords, executionInput, runBinding };
}
...
function loadSignerContext(config, handoff) {
  ...
  const { repositoryRoot, syntheticTest, candidateManifest, candidateSignature, candidateTrustStore, execution, candidateRuntime, governance, identity, loadedRecords, executionInput } = prepared;
