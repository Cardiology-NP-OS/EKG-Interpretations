...
function validateManifest(manifest) {
  ...
  requireCondition(
    typeof manifest.decoder.Pillow === "string" && manifest.decoder.Pillow.length > 0 &&
    typeof manifest.decoder.pypdfium2 === "string" && manifest.decoder.pypdfium2.length > 0 &&
  ...
  manifest.pages.forEach((page, index) => {
    ...
    requireCondition(page.width * page.height <= DECODER_LIMITS.maxPagePixels, "IMAGE_DECODER_PAGE_MANIFEST");
    requireCondition(
