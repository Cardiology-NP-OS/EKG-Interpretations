...
function verifyEvaluationBundle(bundlePath, publicKeyPem, options = {}) {
  ...
  return { schema: "ekg-evaluation-bundle-verification-v1", pass: true, merkleRootSha256, signerKeyId: signature.signerKeyId, artifactCount: Object.keys(hashes).length, runManifest };
}
