...
function runImageSignalAnalysis(extraction, config) {
  ...
  const simultaneousPaperGroups = buildSimultaneousPaperGroups(leadAnalyses);
  return {
    ...
    temporalAlignmentPolicy: "STANDARD_3X4_PANEL_WINDOWS_ONLY_RHYTHM_STRIP_EXCLUDED_FROM_SIMULTANEOUS_GROUPS",
    diagnosticInterpretationIncluded: false,
    ...ANALYSIS_GOVERNANCE,
  };
}
