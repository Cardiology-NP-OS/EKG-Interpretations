# ECG-Capable Smartwatches Dataset

- Canonical dataset ID: `ECG-DATASET-ECG-CAPABLE-SMARTWATCHES-DATASET`
- Canonical source: https://physionet.org/content/ecg-capable-smartwatches/1.0.0/
- Exact version/release: 1.0.0
- Access: restricted
- License/access terms: PhysioNet Restricted Health Data License 1.5.0
