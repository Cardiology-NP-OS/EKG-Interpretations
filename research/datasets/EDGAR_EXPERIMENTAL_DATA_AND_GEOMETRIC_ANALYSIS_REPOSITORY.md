# EDGAR (Experimental Data & Geometric Analysis Repository)

- Canonical dataset ID: `ECG-DATASET-EDGAR-EXPERIMENTAL-DATA-AND-GEOMETRIC-ANALYSIS-REPOSITORY`
- Canonical source: https://edgar.sci.utah.edu/
- Exact version/release: NOT_CAPTURED_IN_ACCEPTED_PROVENANCE
- Access: open
- License/access terms: Free registration
