...
- Canonical dataset ID: `ECG-DATASET-MIMIC-III-WAVEFORM-DATABASE-MATCHED-SUBSET`
- Canonical source: https://physionet.org/content/mimic3wdb-matched/1.0/
- Exact version/release: 1.0
- Access: open
- License/access terms: ODbL
