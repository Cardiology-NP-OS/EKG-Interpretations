...
- Canonical dataset ID: `ECG-DATASET-NSRDB`
- Canonical source: https://physionet.org/content/nsrdb/1.0.0/
...
- Record count: donor split enumerates 18 record IDs
- Leads: ambulatory ECG
- Sample rate: SOURCE_SPECIFIC_REVIEW_REQUIRED
- Duration: long-duration recordings
- Annotation type: SOURCE_RHYTHM_ANNOTATIONS_OR_RECORD_IDENTITY
- Label origin: source rhythm annotations/record identity
