# Nightingale NTUH Cardiac Arrest ECG Dataset

- Canonical dataset ID: `ECG-DATASET-NIGHTINGALE-NTUH-CARDIAC-ARREST-ECG-DATASET`
- Canonical source: https://docs.ngsci.org/datasets/arrest-ntuh-ecg/
- Exact version/release: NOT_CAPTURED_IN_ACCEPTED_PROVENANCE
- Access: restricted
- License/access terms: Institutional credentials
