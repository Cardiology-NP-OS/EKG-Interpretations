# tOLIet (Thigh-based ECG, toilet seat)

- Canonical dataset ID: `ECG-DATASET-TOLIET-THIGH-BASED-ECG-TOILET-SEAT`
- Canonical source: https://physionet.org/content/tollet/1.0.1/
