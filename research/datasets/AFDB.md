...
- Canonical dataset ID: `ECG-DATASET-AFDB`
- Canonical source: https://physionet.org/content/afdb/1.0.0/
...
- Record count: donor split enumerates 23 record IDs
...
- Label origin: rhythm episode annotations
...
- Leakage risks: episode/window splitting can leak patient/record identity unless record-level split is enforced
