# Harvard-Emory ECG Database (HEEDB)

- Canonical dataset ID: `ECG-DATASET-HARVARD-EMORY-ECG-DATABASE-HEEDB`
- Canonical source: https://bdsp.io/content/heedb/5.0/
- Exact version/release: 5.0
- Access: credentialed
- License/access terms: DUA (BDSP)
