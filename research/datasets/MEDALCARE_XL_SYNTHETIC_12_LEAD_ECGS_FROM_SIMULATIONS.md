# MedalCare-XL (Synthetic 12-Lead ECGs from Simulations)

- Canonical dataset ID: `ECG-DATASET-MEDALCARE-XL-SYNTHETIC-12-LEAD-ECGS-FROM-SIMULATIONS`
- Canonical source: https://doi.org/10.5281/zenodo.8068944
