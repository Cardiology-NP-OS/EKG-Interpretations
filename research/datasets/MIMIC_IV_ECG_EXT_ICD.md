...
- Canonical dataset ID: `ECG-DATASET-MIMIC-IV-ECG-EXT-ICD`
- Canonical source: https://physionet.org/content/mimic-iv-ecg-ext-icd-labels/1.0.1/
- Exact version/release: 1.0.1
- Access: credentialed
- License/access terms: PhysioNet Credentialed Health Data License 1.5.0
