...
- Canonical dataset ID: `ECG-DATASET-QTDB`
- Canonical source: https://physionet.org/content/qtdb/1.0.0/
...
- Record count: 105
- Leads: two-channel excerpts
- Sample rate: 250
- Duration: approximately 15 minutes per record
- Annotation type: WAVE_FIDUCIAL_DELINEATION
- Label origin: wave boundary annotations on selected beats
...
- Patient-level split properties: must be confirmed per source record mapping
- Leakage risks: annotation sparsity and source-database overlap assumptions
