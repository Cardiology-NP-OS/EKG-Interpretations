# torch_ecg bundled sample/benchmark physiological assets

- Canonical dataset ID: `ECG-DATASET-TORCH-ECG-BUNDLED-SAMPLE-BENCHMARK-PHYSIOLOGICAL-ASSETS`
...
## Provenance
- DONOR-004; locator: `donors/deeppsp_torch_ecg/DONOR_MANIFEST.json`
