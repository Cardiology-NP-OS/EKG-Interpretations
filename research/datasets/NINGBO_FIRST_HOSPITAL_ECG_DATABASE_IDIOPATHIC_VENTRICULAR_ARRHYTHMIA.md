# Ningbo First Hospital ECG Database (Idiopathic Ventricular Arrhythmia)

- Canonical dataset ID: `ECG-DATASET-NINGBO-FIRST-HOSPITAL-ECG-DATABASE-IDIOPATHIC-VENTRICULAR-ARRHYTHMIA`
- Canonical source: https://doi.org/10.6084/m9.figshare.c.4668086.v2
