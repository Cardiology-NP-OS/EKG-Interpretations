# CODE (Full Dataset, ~2.3M records)

- Canonical dataset ID: `ECG-DATASET-CODE-FULL-DATASET-2-3M-RECORDS`
- Canonical source: https://figshare.scilifelab.se/articles/dataset/CODE_dataset/15169716
- Exact version/release: NOT_CAPTURED_IN_ACCEPTED_PROVENANCE
- Access: restricted
- License/access terms: DUA required
