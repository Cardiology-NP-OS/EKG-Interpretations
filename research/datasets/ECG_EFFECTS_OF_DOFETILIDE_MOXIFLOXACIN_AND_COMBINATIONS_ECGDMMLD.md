...
- Canonical dataset ID: `ECG-DATASET-ECG-EFFECTS-OF-DOFETILIDE-MOXIFLOXACIN-AND-COMBINATIONS-ECGDMMLD`
- Canonical source: https://physionet.org/content/ecgdmmld/1.0.0/
