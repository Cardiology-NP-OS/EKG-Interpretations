...
- Canonical dataset ID: `ECG-DATASET-EUROPEAN-ST-T-DATABASE-EDB`
- Canonical source: https://physionet.org/content/edb/1.0.0/
...
- Annotation type: ST_T_EPISODE_ANNOTATIONS
...
- ST/T episode annotation evaluation
- temporal-event regression
