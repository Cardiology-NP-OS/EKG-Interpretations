# ECG Effects of Ranolazine, Dofetilide, Verapamil, Quinidine (ECGRDVQ)

- Canonical dataset ID: `ECG-DATASET-ECG-EFFECTS-OF-RANOLAZINE-DOFETILIDE-VERAPAMIL-QUINIDINE-ECGRDVQ`
- Canonical source: https://physionet.org/content/ecgrdvq/1.0.0/
- Exact version/release: 1.0.0
- Access: open
- License/access terms: ODC Attribution
