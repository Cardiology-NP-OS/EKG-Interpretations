# Nightingale BWH Emergency Dept ECG Dataset

- Canonical dataset ID: `ECG-DATASET-NIGHTINGALE-BWH-EMERGENCY-DEPT-ECG-DATASET`
- Canonical source: https://docs.ngsci.org/datasets/ed-bwh-ecg/
