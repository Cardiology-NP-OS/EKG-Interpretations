# Eye Tracking Dataset for 12-Lead ECG Interpretation

- Canonical dataset ID: `ECG-DATASET-EYE-TRACKING-DATASET-FOR-12-LEAD-ECG-INTERPRETATION`
- Canonical source: https://physionet.org/content/eye-tracking-ecg/1.0.0/
- Exact version/release: 1.0.0
- Access: open
- License/access terms: ODC ODbL 1.0
