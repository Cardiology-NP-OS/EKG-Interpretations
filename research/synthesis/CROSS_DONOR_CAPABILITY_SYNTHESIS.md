...
- **ECG-CAP-EVENT-BEAT-RHYTHM-REPRESENTATION ? Beat, rhythm, and event feature representations:** MIT-LCP/wfdb-python, vitaldb/openecg, DeepPSP/torch_ecg. Canonical home: `lib/signal_intelligence_workflow.js` with evaluation contract `evaluation/protocols/RHYTHM_FEATURE_AND_CANDIDATE_CONTRACT.json`.
- **ECG-CAP-EVENT-FIDUCIAL-DELINEATION ? P/QRS/T fiducial delineation:** vitaldb/openecg, neuropsychology/NeuroKit, vlbthambawita/ECGBench. Canonical home: `lib/signal_delineation_contract.js` with evaluation contract `evaluation/protocols/FIDUCIAL_DELINEATION_CONTRACT.json`.
