...
At the prepared handoff basis, 11/21 primary donors are accepted and the next frontier is DONOR-012 `Edoardo-BS/HuBERT-ECG`. Treat that only as a handoff hint; the live registry wins.
