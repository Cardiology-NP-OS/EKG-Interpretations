...
At the prepared handoff basis, 10/21 primary donors are accepted and the next frontier is DONOR-011 `PKUDigitalHealth/ECGFounder`. Treat that only as a handoff hint; the live registry wins.
